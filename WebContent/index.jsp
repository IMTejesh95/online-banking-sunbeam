			...
			<div class="w3ls-about agile-section">
					<div class="w3-agileits-about-grids">
						<div class="col-md-6 col-sm-6 col-xs-6 agileits-title">
							<h3>what makes <img src="bootstrap/dist/template/images/logo.png" alt="logo"/>Unique?</h3> 
						</div>
	...
	<div class="w3ls-section services">
		<div class="container">
			<div class="services-left">
				...
				<p class="data">Want to beacome a BO$$,</p>
				<div class="more sr-txt">
					<a href="register" >Open Account Now..</a>
				</div>
			</div>
					...
					<div class="w3_agile_testimonials_grid">
						<div class="w3_agile_testimonials_grid_left">
							<div class="col-md-3 col-sm-3 col-xs-3 w3l-testi-img">
								<img src="bootstrap/dist/template/images/13.jpg" alt=" " class="img-responsive"/>
							</div>	
			...
			<div class="col-md-6 col-sm-6 agile_testimonials_grid">
				<div class="agile_testimonials_grid1">
					...
					<div class="w3_agile_testimonials_grid">
						<div class="w3_agile_testimonials_grid_left">
							<div class="col-md-3 col-sm-3 col-xs-3 w3l-testi-img">
								<img src="bootstrap/dist/template/images/10.jpg" alt=" " class="img-responsive"/>
							</div>	
							<div class="col-md-9 col-sm-9 col-xs-9 w3l-testi-txt">
								<h4>Alejandra</h4>
								<p>fames ac turpis</p>
			...
			<div class="col-md-6 col-sm-6 agile_testimonials_grid">
				<div class="agile_testimonials_grid1">
					...
					<div class="w3_agile_testimonials_grid">
						<div class="w3_agile_testimonials_grid_left">
							<div class="col-md-3 col-sm-3 col-xs-3 w3l-testi-img">
								<img src="bootstrap/dist/template/images/11.jpg" alt=" " class="img-responsive"/>
							</div>	
							<div class="col-md-9 col-sm-9 col-xs-9 w3l-testi-txt">
								<h4>Charles</h4>
								<p>fames ac turpis</p>
			...
			<div class="col-md-6 col-sm-6 agile_testimonials_grid">
				<div class="agile_testimonials_grid1">
					...
					<div class="w3_agile_testimonials_grid">
						<div class="w3_agile_testimonials_grid_left">
							<div class="col-md-3 col-sm-3 col-xs-3 w3l-testi-img">
								<img src="bootstrap/dist/template/images/12.jpg" alt=" " class="img-responsive" />
							</div>
							<div class="col-md-9 col-sm-9 col-xs-9 w3l-testi-txt">
								<h4>Jessie</h4>
								<p>fames ac turpis</p>
...
<!--//footer-->	
		...
		<div class="modal-dialog" role="document">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<img src="bootstrap/dist/template/images/logo.png" alt="logo"/>
				</div>
				<div class="modal-body">
					<img src="bootstrap/dist/template/images/modal.jpg" class="img-responsive" alt="image">
	...
	<script src="bootstrap/dist/template/js/responsiveslides.min.js"></script>
	<script>
